...
async function commandStart(ctx) {
    await ctx.replyWithPhoto(
        ...
        {caption: `👋Привет, на связи INFULL DIGITAL. Мы занимаемся оптимизацией и автоматизацией бизнес-процессов в больших и маленьких компаниях.\n
Я <b>Павел</b>, руководитель нашей команды. За последние несколько лет мы реализовали <b>327 кейсов</b> на самых сложных рынки (страхование, лизинг, недвижимость, авто дилеры и тд).\n
И да, хочу показать, как работает CRM в компании с <b>1,5 млрд. ₽.</b>\n
